...
public final class LogHelper {
    ...
    private static String buildMsg( Supplier<String> msgFac, Exception e){
        String msg = "";
        if (msgFac!=null){
            msg = msgFac.get();
        }
    ...
    private static void log(Supplier<Boolean> levelEnableTest, BiConsumer<String, Throwable> logFunc, Supplier<String> msgFac, Exception e){
        if(levelEnableTest==null?true:levelEnableTest.get()){
            logFunc.accept(buildMsg(msgFac, e), e);
        }
    }

    public static void trace(Logger logger, Supplier<String> facMsg, Exception e){
        logger = buildLogger(logger);
        log(logger::isTraceEnabled, logger::trace, facMsg, e);
    }

    public static void debug(Logger logger, Supplier<String> facMsg, Exception e){
        logger = buildLogger(logger);
        log(logger::isDebugEnabled, logger::debug, facMsg, e);
    }

    public static void info(Logger logger, Supplier<String> facMsg, Exception e){
        logger = buildLogger(logger);
        log(logger::isInfoEnabled, logger::info, facMsg, e);
    }

    public static void warn(Logger logger, Supplier<String> facMsg, Exception e){
        logger = buildLogger(logger);
        log(logger::isWarnEnabled, logger::warn, facMsg, e);
    }

    public static void error(Logger logger, Supplier<String> facMsg, Exception e){
        logger = buildLogger(logger);
    ...
    public static void trace(Supplier<String> facMsg, Exception e){
        Logger logger = buildLogger(null);
        log(logger::isTraceEnabled, logger::trace, facMsg, e);
    }

    public static void debug(Supplier<String> facMsg, Exception e){
        Logger logger = buildLogger(null);
        log(logger::isDebugEnabled, logger::debug, facMsg, e);
    }

    public static void info(Supplier<String> facMsg, Exception e){
        Logger logger = buildLogger(null);
        log(logger::isInfoEnabled, logger::info, facMsg, e);
    }

    public static void warn(Supplier<String> facMsg, Exception e){
        Logger logger = buildLogger(null);
        log(logger::isWarnEnabled, logger::warn, facMsg, e);
    }

    public static void error(Supplier<String> facMsg, Exception e){
        Logger logger = buildLogger(null);
        log(logger::isErrorEnabled, logger::error, facMsg, e);
    }
